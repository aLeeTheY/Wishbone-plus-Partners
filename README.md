...
|    <code>postinstall</code>    |                                                       <code>npm run md:decode</code>                                                       |     Автоматически восстанавливает исходный формат README-файлов после установки проекта     |
|     <code>md:encode</code>     |       <code>npx tsx cli/transform&#8209;md.ts encode README.md README.EN.md && npx prettier &#8209;&#8209;write \"\*_/_.md\"</code>        |  Фиксирует верстку и оптимизирует отображение README-файлов перед отправкой в репозиторий   |
|     <code>md:decode</code>     |       <code>npx tsx cli/transform&#8209;md.ts decode README.md README.EN.md && npx prettier &#8209;&#8209;write \"\*_/_.md\"</code>        | Возвращает README-файлы к стандартному Markdown-виду для удобного локального редактирования |
