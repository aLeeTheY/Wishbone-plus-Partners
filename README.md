...
> [!IMPORTANT] Browser compatibility was verified for the 1.0.0 release. The site displayed correctly in the latest versions of all major browsers at that time.
>
...
Copyright © 2025 [Vladimir Nikulin](https://github.com/aLeeTheY).<br /> This project is [MIT][license-url] licensed.
